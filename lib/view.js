...
utils.delegate(View.prototype, {
  ...
  init: function (view) {
    ...
    if (view.stat) {
      define(view, 'history', view.history);
      define(view, '_contents', view._contents);
      define(view, 'stat', view.stat);
    }

    view.__proto__ = this;
    define(view, '_callbacks', view._callbacks);
...
mixin('cwd', {
  ...
  set: function(cwd) {
    define(this, '_cwd', cwd ? path.resolve(cwd) : process.cwd());
  }
});
