...
module.exports = function (app) {
  ...
  app.defineProp('helperType', function(type) {
  ...
  app.defineProp('loadHelpers', function() {
  ...
  app.defineProp('helper', function(name, fn) {
  ...
  app.defineProp('getHelper', function(name) {
  ...
  app.defineProp('getAsyncHelper', function(name) {
  ...
  app.defineProp('helpers', function(helpers, options) {
  ...
  app.defineProp('asyncHelper', function(name, fn) {
  ...
  app.defineProp('asyncHelpers', function(helpers, options) {
  ...
  app.defineProp('engineHelpers', function(ext) {
  ...
  app.defineProp('defaultHelper', function(collectionName, plural) {
  ...
  app.defineProp('defaultAsyncHelper', function(collectionName, plural) {
