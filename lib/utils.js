...
utils.getType = function (name, thisArg, types) {
  debug.utils('[utils] getType:', arguments);
  var val = null;
...
utils.getRenderable = function (name, thisArg) {
  ...
  return utils.getType(name, thisArg, ['renderable']);
};
...
utils.getLayout = function (name, thisArg) {
  ...
  return utils.getType(name, thisArg, ['layout']);
};
...
utils.getPartial = function (name, thisArg) {
  ...
  return utils.getType(name, thisArg, ['partial']);
};
