...
utils.delegate(View.prototype, {
  ...
  init: function (view) {
    ...
    assign(this, 'options', view.options || {});
    this.options.collectionName = this.collection.options.collection;
  ...
  /**
   * Return a clone of the view.
   */

  clone: function (obj, keys) {
    var Constructor = this.constructor;

    var res = new Constructor(obj || this, this.options);
  ...
  */
  ...
  excerpt: function (options) {
    var opts = this.pickOption('excerpt', options);
    var re = /<!--+\s*more\s*--+>/;
    var str = this.content;
    var view = this;

    var link = opts.link || '<a id="more"></a>';
