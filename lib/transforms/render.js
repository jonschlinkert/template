...
module.exports = function (app) {
  ...
  app.defineProp('compileBase', function(engine, template, options) {
  ...
  app.defineProp('compileTemplate', function(template, settings, isAsync) {
  ...
  app.defineProp('compile', function(content, options, isAsync) {
  ...
  app.defineProp('compileString', function(content, options, isAsync) {
  ...
  app.defineProp('renderBase', function(engine, content, options, cb) {
  ...
  app.defineProp('renderTemplate', function(template, locals, cb) {
  ...
  app.defineProp('renderAsync', function(engine, content, options, cb) {
    if (typeof options === 'function') {
      cb = options;
      options = {};
    }
  ...
  app.defineProp('renderSync', function(engine, content, options) {
  ...
  app.defineProp('render', function(content, locals, cb) {
  ...
  app.defineProp('renderString', function(str, locals, cb) {
  ...
  app.defineProp('renderFile', function(locals) {
  ...
  app.defineProp('renderEach', function(collection, locals, cb) {
    if (typeof locals === 'function') {
      cb = locals;
      locals = {};
    }
  ...
  app.defineProp('renderEachAsync', function(collection, locals, cb) {
    if (typeof locals === 'function') {
      cb = locals;
      locals = {};
    }
  ...
  app.defineProp('renderEachSync', function(collection, locals) {
    var views = this.getViews(collection);
    var res = [];
  ...
  app.defineProp('handleTemplate', function (method, file) {
