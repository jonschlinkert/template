...
* [API](#api)
  - [Render a template](#render-a-template)
* [Register an engine](#register-an-engine)
* [Load templates](#load-templates)
* [Custom templates](#custom-templates)
* [Custom loaders](#custom-loaders)
  - [Template-specific loaders](#template-specific-loaders)
  - [Loader requirements](#loader-requirements)
* [API](#api)
...
* `type` **{String}**: Types are `renderable`, `layout` and `partial`.
...
* `collection` **{String}**: The name of the collection to render.
* `locals` **{Object}**: Locals object and/or options to pass to the engine as context.
