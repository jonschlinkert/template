...
module.exports = function (app) {
  ...
  app.defineProp('mergeType', function (type, collections) {
    collections = this.getType(type, collections);
    var templates = {};
    for (var key in collections) {
      var collection = collections[key];
      for (var name in collection) {
        if (!templates.hasOwnProperty(name) && collection.hasOwnProperty(name)) {
          templates[name] = collection[name];
        }
      }
    }
    return templates;
  ...
  app.defineProp('mergeLayouts', function(fn) {
  ...
  app.defineProp('mergePartials', function(context) {
  ...
  app.defineProp('mergeContext', function(template, locals) {
  ...
  app.defineProp('bindHelpers', function (options, context, isAsync) {
  ...
  app.defineProp('mergeTypeContext', function (app, type) {
