...
var permalinks = lazy('permalinks');
...
utils.delegate(View.prototype, {
  ...
  permalink: function (pattern, locals) {
    if (typeof pattern !== 'string') {
      locals = pattern;
      pattern = null;
    }

    var data = this.pickOption('permalinks') || {};
    var fn = permalinks();
    ...
    var opts = data.permalinks || {};
    pattern = pattern || opts.pattern || ':path';

    return fn(pattern, data, opts);
  },
