...
module.exports = function (app) {
  ...
  /**
   * Get all view collections of the given [type]. For example, get all `renderable`
   * views, or all `partial` views.
   *
   * ```js
  ...
  app.defineProp('getType', function(type, collections) {
  ...
  app.defineProp('getView', function(collection, key, fn) {
  ...
  app.defineProp('getViews', function(plural) {
  ...
  app.defineProp('matchView', function(collection, pattern, options) {
    var views = this.getViews(collection);
  ...
  app.defineProp('matchViews', function(collection, pattern, options) {
    var views = this.getViews(collection);
  ...
  app.defineProp('lookup', function(collectionName, name, ext, fn) {
  ...
  app.defineProp('find', function(viewType, name, collectionNames) {
  ...
  app.defineProp('findRenderable', function(key, collections) {
  ...
  app.defineProp('findLayout', function(key, collections) {
  ...
  app.defineProp('findPartial', function(key, collections) {
