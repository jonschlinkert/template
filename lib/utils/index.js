...
utils.cloneDeep = require('clone-deep');
...
utils.defineProp = function mixin(receiver, key, value) {
...
/**
 * Create a new object, forwarding the provider's instance onto the receiver.
 */

utils.forward = function forward(receiver, provider) {
