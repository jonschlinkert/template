...
module.exports = function (app) {
  ...
  app.mixin('compileTemplate', function(template, settings, isAsync) {
    ...
    // compile template
    return this.compileBase(engine, template.content, extend({}, opts, context));
  });
  ...
  app.mixin('renderTemplate', function(template, locals, cb) {
    ...
    this.handleFile('preRender', template);
  ...
  app.mixin('handleFile', function (method, file) {
    var hasMethod = utils.get(file, ['options.method', method]);
    if (!hasMethod) {
