...
utils.delegate(View.prototype, {
  ...
  permalink: function (locals) {
    ...
    data.permalinks = data.permalinks || this.pickOption('permalinks');
    data.permalinks.structure = data.permalinks.structure || ':name.:ext';
    return permalinks(data.permalinks.structure, data, data);
  },
