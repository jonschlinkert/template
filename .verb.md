# {%= name %} {%= badge("fury") %} {%= badge("travis") %} [![Coverage Status](https://img.shields.io/coveralls/jonschlinkert/template.svg)](https://coveralls.io/r/jonschlinkert/template)

> {%= description %}

Go to the [API documentation](./docs/api.md)

- **~100% test coverage** (as of {%= date('MMM. DD, YYYY') %}) with [~500 unit tests](./tests)
