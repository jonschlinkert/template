  ...
  view.visit('mixin', {
    ...
    paginate: function (view, options) {
      ...
      function createPage() {
        ...
        page.data.pagination = new Parent(extend({}, self.options, {Item: Item}));
        return page;
      }
      ...
      var pages = new Parent(extend({}, this.options, opts, {Item: View}));
      var page = createPage();
    ...
    groupBy: function (prop, fn) {
      ...
      var grouper = function (acc, value, idx, arr, setter) {
        ...
        while (++i < len) {
          setter(acc, groups[i], value, idx, arr);
        }
      };

      var setter = function (acc, group, value) {
