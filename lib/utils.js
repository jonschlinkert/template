...
utils.pickCached = function (name, thisArg, types) {
...
utils.pickRenderable = function (name, thisArg) {
  debug.utils('[utils] pickRenderable:', arguments);
  return utils.pickCached(name, thisArg);
};
...
utils.pickPartial = function (name, thisArg) {
  debug.utils('[utils] pickPartial:', arguments);
  return utils.pickCached(name, thisArg, ['partial']);
};
