...
var lazyDetect = lazy('file-conflicts');
var assign = lazy('assign-value');
var clone = lazy('clone-deep');
var omit = lazy('object.omit');
var lazyCopy = lazy('copy');
var lazyWrite = lazy('write');
...
Object.defineProperty(View.prototype, 'cwd', {
  get: function() {
...
Object.defineProperty(View.prototype, 'relative', {
  get: function() {
    if (!this.base) {
...
Object.defineProperty(View.prototype, 'absolute', {
  get: function() {
    if (!this.path) {
...
Object.defineProperty(View.prototype, 'dirname', {
  get: function() {
    if (!this.path) {
...
Object.defineProperty(View.prototype, 'basename', {
  get: function() {
    if (!this.path) {
...
Object.defineProperty(View.prototype, 'extname', {
  get: function() {
    if (!this.path) {
